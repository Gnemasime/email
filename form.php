                            ...
                            <div class="container col-lg-7">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Volunteer Application</h1>
                                    </div>
                                    <form class="user" method="POST">

                                    <div class="form-group">
                                            <input type="text" name="name" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Enter your name">
                                        </div>

                                        <div class="form-group">
                                            <input type="text" name="surname" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Enter your surname">
                                        </div>

                                        <div class="form-group">
                                            <input type="number" name="cell" maxlength="10" class="form-control form-control-user"
                                                id="inputField" oninput="checkLength()" aria-describedby="emailHelp"
                                                placeholder="Enter cell no."> 
                                                <div id="errorMessage" style="color:red; display: none;"><p>Maximum length exceeded</p></div>
                                        </div>
